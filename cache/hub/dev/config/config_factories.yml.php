...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/Applications/MAMP/htdocs/volar/log/hub_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/Applications/MAMP/htdocs/volar/cache/hub/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/Applications/MAMP/htdocs/volar/apps/hub/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('sesion_nueva_callcenter'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Applications/MAMP/htdocs/volar/cache/hub/dev/template',
  'lifetime' => 86400,
  'prefix' => '/Applications/MAMP/htdocs/volar/apps/hub/template',
)));
