        ...
        <?php }?>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
                ...
                <!-- form start -->
                <form class="filtroRangos" role="form" id="myForm" action="<?php echo url_for('/descuento/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
                ...
                <div class="tab-content">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group col-md-2 <?php if($form['tipo']->renderError()) echo "has-error"; ?>">
                      <label for="nickname"><?php if($form['tipo']->renderError()) echo '<i class="fa fa-times-circle-o"></i>'; ?>Descuento/Cupon </label>
                      <?php  echo $form['tipo'];?>
                    </div>  
                      
                    <div class="form-group col-md-10 <?php if($form['nombre']->renderError()) echo "has-error"; ?>">
                      <label for="nickname"><?php if($form['nombre']->renderError()) echo '<i class="fa fa-times-circle-o"></i>'; ?>Titulo del descuento/Cupon</label>
                   ...
                   <div class="form-group col-md-4 <?php if($form['categoria_id']->renderError()) echo "has-error"; ?>">
                    ...
                    <div class="form-group col-md-4 <?php if($form['proveedor_id']->renderError()) echo "has-error"; ?>">
                     ...
                     <div class="form-group col-md-4 <?php if($form['proveedor_sucursal_id']->renderError()) echo "has-error"; ?>">
                      ...
                      <div class="form-group col-md-6 <?php if($form['fecha_limite']->renderError()) echo "has-error"; ?>">
                      <label for="nickname"><?php if($form['fecha_limite']->renderError()) echo '<i class="fa fa-times-circle-o"></i>'; ?>Fecha activación-finalización</label>
                      <?php  echo $form['fecha_limite'];?>
                    </div>

                   
                      <div class="form-group col-md-2 <?php if($form['num_descuentos']->renderError()) echo "has-error"; ?>">
                      <label for="telefono1"><?php if($form['num_descuentos']->renderError()) echo '<i class="fa fa-times-circle-o"></i>'; ?>Valor inicial</label>
                      <?php  echo $form['num_descuentos'];?>
                    </div>
                      
                     <div class="form-group col-md-2 <?php if($form['comportamiento']->renderError()) echo "has-error"; ?>">
                      <label for="telefono2"><?php if($form['comportamiento']->renderError()) echo '<i class="fa fa-times-circle-o"></i>'; ?>Comportamiento</label>
                      <?php  echo $form['comportamiento'];?>
                    </div>
                      
                    <div class="form-group  col-md-2  <?php if($form['aplicacion']->renderError()) echo "has-error"; ?>">
                      <label for="email"><?php if($form['aplicacion']->renderError()) echo '<i class="fa fa-times-circle-o"></i>'; ?>Disminucion</label>
                      <?php  echo $form['aplicacion'];?>
                    </div>
                ...
                <div class="box-body no-padding">
                  <table class="table table-striped">
                    ...
                    <td>
                         ...
                         <button class="btn btn-social-icon btn-google-plus" onclick="removeEtiqueta('galerias<?php echo $i ?>','<?php echo url_for('descuento/delGalerias')."?id=".$form['galerias'][$i]['id']->getValue() ?>')" type="button"><i class="fa fa-bitbucket"></i></button>
...
function addGaleria(num) {
  ...
  var r = $.ajax({
    type: 'GET',
    url: '<?php echo url_for('/descuento/addGaleriaForm')?>'+'<?php echo   ($form->getObject()->isNew()?'':'?id='.$form->getObject()->getId()).($form->getObject()->isNew()?'?num=':'&num=')?>'+num,
    async: false
  }).responseText;
  return r;
}
