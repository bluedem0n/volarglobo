<section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Servicios/productos del proveedor</li>
          </ol>
        </section>

        <div style="">
        <a href="<?php echo url_for('producto/new')?>"  class="btn  btn-social btn-dropbox" style="float: right;  width: 110px; margin-left: 5px; margin-right: 15px">
                ...
                <div class="box-body  no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle"><?php echo $descuento->getFechaActivacion(); ?></td>
                        <td style="vertical-align: middle"><?php echo $descuento->getFechaFinalizacion(); ?></td>
                      <td>
