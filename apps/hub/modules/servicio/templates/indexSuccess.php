<section class="content-header">
        ...
        <div style="">
        <a href="<?php echo url_for('servicio/new')?>"  class="btn  btn-social btn-dropbox" style="float: right;  width: 110px; margin-left: 5px; margin-right: 15px">
...
<!--                  <div class="input-group">
          ...
          <div class="box">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <form action="<?php echo url_for('servicio/index')?>" method="post">
              ...
              <?php if($descuento->getStatus()==2){ ?>
                <li><a href="<?php echo url_for('servicio/status?cambia=1&id='.$descuento->getId()); ?>"><i class="fa fa-fw fa-thumbs-up" style="cursor: pointer; color: green" title="Aprobar"></i>Aprobar</a></li>
                <?php }elseif($descuento->getStatus()==1){ ?>
                <li><a href="<?php echo url_for('servicio/status?cambia=2&id='.$descuento->getId()); ?>"><i class="fa fa-fw fa-thumbs-down" style="cursor: pointer; color: red" title="Rechazado"></i>Rechazar</a></li>
                <?php }elseif($descuento->getStatus()==0){ ?>
                <li><a href="<?php echo url_for('servicio/status?cambia=1&id='.$descuento->getId()); ?>"><i class="fa fa-fw fa-thumbs-up" style="cursor: pointer; color: green" title="Aprobar"></i>Aprobar</a></li>
                <li><a href="<?php echo url_for('servicio/status?cambia=2&id='.$descuento->getId()); ?>"><i class="fa fa-fw fa-thumbs-down" style="cursor: pointer; color: red" title="Rechazado"></i>Rechazar</a></li>
                ...
                <?php }?>  
                                      ...
                                      <li><a href="<?php echo url_for('servicio/edit?id='.$descuento->getId()); ?>">Editar</a></li>
                                      <li class="divider"></li>
                                      <li><?php echo link_to('Eliminar proveedor', 'servicio/delete?id='.$descuento->getId(), array('method' => 'delete', 'confirm' => 'Esta seguro?', 'style' => 'color:red;'));?>
                                      </li>
                                    </ul>
                            </div>
...
<!--Paginacion de Proveedores ------------------------------------------------>
                ...
                <div class="box-footer clearfix">
                  ...
                  <ul class="pagination pagination-sm no-margin pull-right">
                    <li><?php echo link_to('«', 'servicio/index?page_proveedor='.$proveedor_descuentos->getFirstPage()) ?></li>
                    <li><?php echo link_to('&lt;', 'servicio/index?page_proveedor='.$proveedor_descuentos->getPreviousPage()) ?></li>
                    <?php $links = $proveedor_descuentos->getLinks();
                            foreach ($links as $page_proveedor): ?>
                            <?php echo ($page_proveedor == $proveedor_descuentos->getPage()) ? "<li><a style='background: #222d32;color: #fff'>".$page_proveedor."</a></li>" : "<li>".link_to($page_proveedor, 'servicio/index?page_proveedor='.$page_proveedor).'</li>' ?>
                            <?php if ($page_proveedor != $proveedor_descuentos->getCurrentMaxLink()): ?> <?php endif ?>
                            <?php endforeach ?>
                    <li><?php echo link_to('&gt;', 'servicio/index?page_proveedor='.$proveedor_descuentos->getNextPage()) ?></li>
                    <li><?php echo link_to('»', 'servicio/index?page_proveedor='.$proveedor_descuentos->getLastPage()) ?></li>
                  </ul>
                    <?php endif ?>
                </div>
