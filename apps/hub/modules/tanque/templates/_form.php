        ...
        <?php }?>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
                 ...
                 <!-- form start -->
                <form class="filtroRangos" role="form" id="myForm" action="<?php echo url_for('/tanque/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                      ...
                      <label for="nombre"><?php if($form['capacidad']->renderError()) echo '<i class="fa fa-times-circle-o"></i>'; ?> Capacidad</label>
              ...
              <div class="box-body">
                ...
                <div class="box-body no-padding">
                  <table class="table table-striped">
                    ...
                    <?php }}else { ?>
                    <?php foreach ($form->getObject()->getMantenimientoTanque() as $mantenimiento){ ?>
                    <tr  id="mantenimientos<?php echo $i ?>">
