        ...
        <?php }?>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
                ...
                <form class="filtroRangos" role="form" id="myForm" action="<?php echo url_for('/excursion_adicional/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
