            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Formulario de ciudad</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="filtroRangos" role="form" id="myForm" action="<?php echo url_for('ciudad/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
                ...
                <?php echo $form->renderGlobalErrors() ?>
                  ...
                  <div class="box-body">
                     ...
                     <div class="form-group  col-md-4  <?php if($form['provincia_id']->renderError()) echo "has-error"; ?>">
                      <label for="ciudad_id"><?php if($form['provincia_id']->renderError()) echo '<i class="fa fa-times-circle-o"></i>'; ?> ciudad</label>
                      <?php  echo $form['provincia_id'];?>
                    </div> 
                      
                      
                    <div class="form-group col-md-6 <?php if($form['nombre']->renderError()) echo "has-error"; ?>">
