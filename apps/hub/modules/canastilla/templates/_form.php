        ...
        <?php }?>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
                 ...
                 <!-- form start -->
                <form class="filtroRangos" role="form" id="myForm" action="<?php echo url_for('/canastilla/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                      ...
                      <div class="form-group col-md-4 <?php if($form['tipo_canastilla_id']->renderError()) echo "has-error"; ?>">
                      <label for="nombre"><?php if($form['tipo_canastilla_id']->renderError()) echo '<i class="fa fa-times-circle-o"></i>'; ?> Tipo canastilla</label>
                      <?php  echo $form['tipo_canastilla_id'];?>
                    </div>
              ...
              <div class="box-body">
                ...
                <div class="box-body no-padding">
                  <table class="table table-striped">
                    ...
                    <?php }}else { ?>
                    <?php foreach ($form->getObject()->getMantenimientoCanastilla() as $mantenimiento){ ?>
                    <tr  id="mantenimientos<?php echo $i ?>">
