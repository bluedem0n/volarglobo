        ...
        <?php }?>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
                ...
                <form class="filtroRangos" role="form" id="myForm" action="<?php echo url_for('/excursion_lugar_interes/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
                  ...
                  <div class="box-body">                      
                    ...
                    <div class="form-group  col-md-4 <?php if($form['nombre']->renderError()) echo "has-error"; ?>">
                      ...
                      <div class="form-group  col-md-4 <?php if ($form['imagen']->renderError()) echo "has-error"; ?>">
                          <label for="imagen"><?php if ($form['imagen']->renderError()) echo '<i class="fa fa-times-circle-o"></i>'; ?> Imagen</label>
