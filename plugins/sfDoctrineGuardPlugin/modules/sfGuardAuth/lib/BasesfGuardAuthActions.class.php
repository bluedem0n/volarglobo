...
class BasesfGuardAuthActions extends sfActions
{
  ...
  public function executeSignout($request)
  {
    ...
    $this->getUser()->getAttributeHolder()->remove('agente_user');
    $this->getUser()->getAttributeHolder()->remove('agente_user_empresa_id');
    $this->getUser()->getAttributeHolder()->remove('agente_user_fecha_ultima');
