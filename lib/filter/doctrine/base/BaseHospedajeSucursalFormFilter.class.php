...
/**
 * HospedajeSucursal filter form base class.
 *
 ...
 */
abstract class BaseHospedajeSucursalFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('hospedaje_sucursal_filters[%s]');
