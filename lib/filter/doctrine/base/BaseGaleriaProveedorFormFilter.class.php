...
/**
 * GaleriaProveedor filter form base class.
 *
 ...
 */
abstract class BaseGaleriaProveedorFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('galeria_proveedor_filters[%s]');
