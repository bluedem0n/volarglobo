...
/**
 * GaleriaDescuento filter form base class.
 *
 ...
 */
abstract class BaseGaleriaDescuentoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('galeria_descuento_filters[%s]');
