...
/**
 * VehiculoModeloMarca filter form base class.
 *
 ...
 */
abstract class BaseVehiculoModeloMarcaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vehiculo_modelo_marca_filters[%s]');
