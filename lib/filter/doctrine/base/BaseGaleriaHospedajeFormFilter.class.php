...
/**
 * GaleriaHospedaje filter form base class.
 *
 ...
 */
abstract class BaseGaleriaHospedajeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('galeria_hospedaje_filters[%s]');
