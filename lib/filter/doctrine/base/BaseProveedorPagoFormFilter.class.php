...
/**
 * ProveedorPago filter form base class.
 *
 ...
 */
abstract class BaseProveedorPagoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('proveedor_pago_filters[%s]');
