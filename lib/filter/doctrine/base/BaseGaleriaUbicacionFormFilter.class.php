...
/**
 * GaleriaUbicacion filter form base class.
 *
 ...
 */
abstract class BaseGaleriaUbicacionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('galeria_ubicacion_filters[%s]');
