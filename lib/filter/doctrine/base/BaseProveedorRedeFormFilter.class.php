...
/**
 * ProveedorRede filter form base class.
 *
 ...
 */
abstract class BaseProveedorRedeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('proveedor_rede_filters[%s]');
