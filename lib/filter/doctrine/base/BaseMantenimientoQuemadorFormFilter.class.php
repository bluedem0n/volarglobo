...
/**
 * MantenimientoQuemador filter form base class.
 *
 ...
 */
abstract class BaseMantenimientoQuemadorFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mantenimiento_quemador_filters[%s]');
