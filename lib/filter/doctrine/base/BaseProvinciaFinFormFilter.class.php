...
/**
 * ProvinciaFin filter form base class.
 *
 ...
 */
abstract class BaseProvinciaFinFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('provincia_fin_filters[%s]');
