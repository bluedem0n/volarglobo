...
/**
 * HospedajeRede filter form base class.
 *
 ...
 */
abstract class BaseHospedajeRedeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'rede_id'      => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Rede'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('hospedaje_rede_filters[%s]');
