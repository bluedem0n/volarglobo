 ...
 */
class VueloRestricionesForm extends BaseVueloRestricionesForm
{
  public function configure()
  {
     ...
     unset (
      ...
      $this->widgetSchema['tipo_restriciones_id'] = new sfWidgetFormInputHidden(array(),array()); 
