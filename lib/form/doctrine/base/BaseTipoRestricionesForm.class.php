...
/**
 * TipoRestriciones form base class.
 *
 * @method TipoRestriciones getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseTipoRestricionesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tipo_restriciones[%s]');
