...
/**
 * ProvinciaFin form base class.
 *
 * @method ProvinciaFin getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseProvinciaFinForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('provincia_fin[%s]');
