...
/**
 * VehiculoMarcaModelo form base class.
 *
 * @method VehiculoMarcaModelo getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVehiculoMarcaModeloForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vehiculo_marca_modelo[%s]');
