...
/**
 * TipoPersonal form base class.
 *
 * @method TipoPersonal getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseTipoPersonalForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tipo_personal[%s]');
