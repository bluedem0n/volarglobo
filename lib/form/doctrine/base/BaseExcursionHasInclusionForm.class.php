...
abstract class BaseExcursionHasInclusionForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'excursion_inclusion_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ExcursionInclusion'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'excursion_inclusion_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('ExcursionInclusion'))),
