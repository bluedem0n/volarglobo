...
/**
 * GaleriaProveedor form base class.
 *
 * @method GaleriaProveedor getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseGaleriaProveedorForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('galeria_proveedor[%s]');
