...
/**
 * TipoCama form base class.
 *
 * @method TipoCama getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseTipoCamaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tipo_cama[%s]');
