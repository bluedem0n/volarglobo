...
/**
 * TipoVuelo form base class.
 *
 * @method TipoVuelo getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseTipoVueloForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tipo_vuelo[%s]');
