...
/**
 * HospedajeSucursal form base class.
 *
 * @method HospedajeSucursal getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseHospedajeSucursalForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('hospedaje_sucursal[%s]');
