...
/**
 * TipoHabitacion form base class.
 *
 * @method TipoHabitacion getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseTipoHabitacionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tipo_habitacion[%s]');
