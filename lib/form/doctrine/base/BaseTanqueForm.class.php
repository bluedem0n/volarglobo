...
/**
 * Tanque form base class.
 *
 * @method Tanque getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseTanqueForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tanque[%s]');
