...
/**
 * ProveedorSucursal form base class.
 *
 * @method ProveedorSucursal getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseProveedorSucursalForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('proveedor_sucursal[%s]');
