...
/**
 * GaleriaHospedaje form base class.
 *
 * @method GaleriaHospedaje getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseGaleriaHospedajeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('galeria_hospedaje[%s]');
