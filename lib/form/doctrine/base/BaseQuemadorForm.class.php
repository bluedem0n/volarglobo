...
/**
 * Quemador form base class.
 *
 * @method Quemador getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseQuemadorForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('quemador[%s]');
