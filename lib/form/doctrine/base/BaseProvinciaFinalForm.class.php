...
/**
 * ProvinciaFinal form base class.
 *
 * @method ProvinciaFinal getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseProvinciaFinalForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('provincia_final[%s]');
