...
/**
 * ProveedorPago form base class.
 *
 * @method ProveedorPago getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseProveedorPagoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('proveedor_pago[%s]');
