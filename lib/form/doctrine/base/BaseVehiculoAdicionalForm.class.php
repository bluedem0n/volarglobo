...
/**
 * VehiculoAdicional form base class.
 *
 * @method VehiculoAdicional getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVehiculoAdicionalForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vehiculo_adicional[%s]');
