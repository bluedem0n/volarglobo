...
/**
 * TipoCanastilla form base class.
 *
 * @method TipoCanastilla getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseTipoCanastillaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tipo_canastilla[%s]');
