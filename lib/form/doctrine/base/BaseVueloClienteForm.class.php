...
/**
 * VueloCliente form base class.
 *
 * @method VueloCliente getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseVueloClienteForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vuelo_cliente[%s]');
