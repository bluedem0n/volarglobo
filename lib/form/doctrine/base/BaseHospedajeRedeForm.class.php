...
/**
 * HospedajeRede form base class.
 *
 * @method HospedajeRede getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseHospedajeRedeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('hospedaje_rede[%s]');
