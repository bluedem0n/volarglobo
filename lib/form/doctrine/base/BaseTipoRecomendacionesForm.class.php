...
/**
 * TipoRecomendaciones form base class.
 *
 * @method TipoRecomendaciones getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseTipoRecomendacionesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tipo_recomendaciones[%s]');
