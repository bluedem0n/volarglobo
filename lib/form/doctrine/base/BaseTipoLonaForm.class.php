...
/**
 * TipoLona form base class.
 *
 * @method TipoLona getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseTipoLonaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tipo_lona[%s]');
