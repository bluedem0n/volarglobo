 ...
 */
class VehiculoPoliticaForm extends BaseVehiculoPoliticaForm
{
  ...
  $this->widgetSchema['nombre'] = new sfWidgetFormInputText(array(),array('placeholder'=>'Nombre de la política del vehículo','class' => 'form-control'));
