 ...
 */
class TanqueForm extends BaseTanqueForm
{
  public function configure()
  {
      ...
      $this->widgetSchema['user_name'] = new sfWidgetFormInputHidden(array(),array('value'=> sfContext::getInstance()->getUser()->getAttribute('agente_user_nombre')));
        ...
        $this->widgetSchema['capacidad'] = new sfWidgetFormInputText(array(),array('placeholder'=>'0.00','class' => 'form-control'));
      ...
      //Sucursales 
      $mantenimientos = $this->getObject()->getMantenimientoTanque();
      ...
      foreach ($mantenimientos as $mantenimiento){
          ...
          if($mantenimiento->getEmpresaId()==sfContext::getInstance()->getUser()->getAttribute('agente_user_empresa_id')){
                ...
                $mantenimiento_form = new MantenimientoTanqueForm($mantenimiento);
