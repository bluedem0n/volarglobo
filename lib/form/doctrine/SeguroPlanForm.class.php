 ...
 */
class SeguroPlanForm extends BaseSeguroPlanForm
{
  public function configure()
  {
      //Eliminar los campos del formularios  created_at y updated_at
        ...
        $this->widgetSchema['nombre'] = new sfWidgetFormInputText(array(), array('placeholder' => 'Nombre del plan de seguro', 'class' => 'form-control'));
