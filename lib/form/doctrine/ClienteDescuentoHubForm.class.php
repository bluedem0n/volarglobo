 ...
 */
class ProveedorDescuentoHubForm extends BaseProveedorDescuentoForm
{
  public function configure()
  {
      ...
      $this->widgetSchema['nombre'] = new sfWidgetFormInputText(array(),array('placeholder'=>'Titulo del descuento','class' => 'form-control'));
...
//Cambiar a lista y su validador de los status Activo e Inativo 0/1
        ...
        $this->widgetSchema['observacion'] = new sfWidgetFormTextarea(array(),array('placeholder'=>'Ingresar observaciones relacionadas con el cupon','class' => 'form-control textarea'));
        $this->widgetSchema['condiciones'] = new sfWidgetFormTextarea(array(),array('placeholder'=>'Detallar las condiciones para uso del cupon','class' => 'form-control textarea'));
