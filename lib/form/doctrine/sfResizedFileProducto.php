 ...
 * @version    0.1
 */
class sfResizedFileProducto extends sfValidatedFile
{
	...
	public function save($file = null, $fileMode = 0666, $create = true, $dirMode = 0777)
	{
		...
		if ($file[0] != '/' && $file[0] != '\\' && !(strlen($file) > 3 && ctype_alpha($file[0]) && $file[1] == ':' && ($file[2] == '\\' || $file[2] == '/')))
		{
			...
			//$smallFile = $this->path.DIRECTORY_SEPARATOR.'s_'.$file;
                        //$smallFile = $this->path.DIRECTORY_SEPARATOR.''.$file;
			$file = $this->path.DIRECTORY_SEPARATOR.$file;
                        $smallFile = $this->path.DIRECTORY_SEPARATOR.'s'.$file;
		}
		...
		$thumbnail = new sfThumbnail(150, 150, true, true, 85, '');
		$thumbnail->loadFile($this->getTempName());
		$thumbnail->save($smallFile, 'image/jpeg');

		*/
                
                $thumbnail = new sfThumbnail(500, 500, true, true, 100, '');
		$thumbnail->loadFile($this->getTempName());
