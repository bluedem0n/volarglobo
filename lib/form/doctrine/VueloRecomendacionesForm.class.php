 ...
 */
class VueloRecomendacionesForm extends BaseVueloRecomendacionesForm
{
  public function configure()
  {
     ...
     unset (
      ...
      $this->widgetSchema['tipo_recomendaciones_id'] = new sfWidgetFormInputHidden(array(),array()); 
