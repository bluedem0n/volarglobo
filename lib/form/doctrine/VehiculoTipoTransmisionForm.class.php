 ...
 */
class VehiculoTipoTransmisionForm extends BaseVehiculoTipoTransmisionForm
{
  public function configure()
  {
        ...
        unset(
            ...
            $this->widgetSchema['nombre'] = new sfWidgetFormInputText(array(), array('placeholder' => 'Nombre del tipo de transmisión', 'class' => 'form-control'));
