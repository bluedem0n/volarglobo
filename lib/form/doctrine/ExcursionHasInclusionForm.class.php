 ...
 */
class ExcursionHasInclusionForm extends BaseExcursionHasInclusionForm
{
  public function configure()
  {
      ...
      unset(
        ...
        $this->widgetSchema['excursion_inclusion_id'] = new sfWidgetFormInputHidden();
