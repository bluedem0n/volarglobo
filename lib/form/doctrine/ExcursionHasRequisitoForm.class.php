 ...
 */
class ExcursionHasRequisitoForm extends BaseExcursionHasRequisitoForm
{
  public function configure()
  {
      unset(
        ...
        $this->widgetSchema['excursion_requisito_id'] = new sfWidgetFormInputHidden();
