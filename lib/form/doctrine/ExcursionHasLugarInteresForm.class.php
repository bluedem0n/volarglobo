 ...
 */
class ExcursionHasLugarInteresForm extends BaseExcursionHasLugarInteresForm
{
  public function configure()
  {
      
      unset(
                $this['created_at'], $this['updated_at'], $this['excursion_id']
        );
        ...
        $this->widgetSchema['excursion_lugar_interes_id'] = new sfWidgetFormInputHidden();
