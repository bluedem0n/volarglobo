 ...
 */
class VehiculoTipoForm extends BaseVehiculoTipoForm
{
...
//Eliminar los campos del formularios  created_at y updated_at
        ...
        $this->widgetSchema['nombre'] = new sfWidgetFormInputText(array(), array('placeholder' => 'Nombre del tipo de vehículo', 'class' => 'form-control'));
