...
abstract class BasesfGuardUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tipo_personal_id'   => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TipoPersonal'), 'add_empty' => false)),
      ...
      'alerta'             => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'identificacion'     => new sfValidatorString(array('max_length' => 50)),
      ...
      'tipo_personal_id'   => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('TipoPersonal'), 'required' => false)),
      ...
      'grado_instruccion'  => new sfValidatorString(array('max_length' => 50, 'required' => false)),
      ...
      'alerta'             => new sfValidatorString(array('required' => false)),
