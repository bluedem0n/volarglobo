 ...
 */
class ExcursionAdicionalForm extends BaseExcursionAdicionalForm
{
  public function configure()
  {
        ...
        $this->widgetSchema['nombre'] = new sfWidgetFormInputText(array(), array('placeholder' => 'Nombre del adicional', 'class' => 'form-control'));
        $this->widgetSchema['icono'] = new sfWidgetFormInputText(array(), array('class' => 'form-control'));
