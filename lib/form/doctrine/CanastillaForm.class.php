 ...
 */
class CanastillaForm extends BaseCanastillaForm
{
  public function configure()
  {
      ...
      $this->widgetSchema['user_name'] = new sfWidgetFormInputHidden(array(),array('value'=> sfContext::getInstance()->getUser()->getAttribute('agente_user_nombre')));
        ...
        $this->widgetSchema['tipo_canastilla_id'] = new sfWidgetFormDoctrineChoice(array(
                  'model'     => 'TipoCanastilla',
                  'key_method'=>'getId',
                  'query'    => $tipo_canastilla->getTipoCanastillas(),
      ...
      //Sucursales 
      $mantenimientos = $this->getObject()->getMantenimientoCanastilla();
      ...
      foreach ($mantenimientos as $mantenimiento){
          ...
          if($mantenimiento->getEmpresaId()==sfContext::getInstance()->getUser()->getAttribute('agente_user_empresa_id')){
                ...
                $mantenimiento_form = new MantenimientoCanastillaForm($mantenimiento);
