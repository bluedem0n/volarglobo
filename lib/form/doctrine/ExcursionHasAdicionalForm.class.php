 ...
 */
class ExcursionHasAdicionalForm extends BaseExcursionHasAdicionalForm
{
  public function configure()
  {
      ...
      unset(
        ...
        $this->widgetSchema['excursion_adicional_id'] = new sfWidgetFormInputHidden();
