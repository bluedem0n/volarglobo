 ...
 */
class SeguroBeneficioForm extends BaseSeguroBeneficioForm
{
  public function configure()
  {
      unset(
        ...
        $this->widgetSchema['nombre'] = new sfWidgetFormInputText(array(), array('placeholder' => 'Nombre del tipo de seguro', 'class' => 'form-control'));
