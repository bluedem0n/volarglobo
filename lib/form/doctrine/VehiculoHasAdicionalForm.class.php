 ...
 */
class VehiculoHasAdicionalForm extends BaseVehiculoHasAdicionalForm
{
  public function configure()
  {
      unset(
        ...
        $this->widgetSchema['vehiculo_adicional_id'] = new sfWidgetFormInputHidden();
