 ...
 */
class VehiculoCategoriaForm extends BaseVehiculoCategoriaForm
{
  ...
  $this->widgetSchema['nombre'] = new sfWidgetFormInputText(array(),array('placeholder'=>'Nombre de la categoría','class' => 'form-control'));
