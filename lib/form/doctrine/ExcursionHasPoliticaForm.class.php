 ...
 */
class ExcursionHasPoliticaForm extends BaseExcursionHasPoliticaForm
{
  public function configure()
  {
      unset(
        ...
        $this->widgetSchema['excursion_politica_id'] = new sfWidgetFormInputHidden();
