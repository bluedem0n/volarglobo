 ...
 */
class ExcursionPoliticaForm extends BaseExcursionPoliticaForm
{
  public function configure()
  {
      ...
      unset(
        ...
        $this->widgetSchema['nombre'] = new sfWidgetFormInputText(array(), array('placeholder' => 'Nombre del tipo de política', 'class' => 'form-control'));
