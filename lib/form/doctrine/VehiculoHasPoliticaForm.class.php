 ...
 */
class VehiculoHasPoliticaForm extends BaseVehiculoHasPoliticaForm
{
  public function configure()
  {
      ...
      $this->widgetSchema['vehiculo_politica_id'] = new sfWidgetFormInputHidden();
