 ...
 */
class RangoEdadForm extends BaseRangoEdadForm
{
  public function configure()
  {
      ...
      $this->widgetSchema['rango_desde'] = new sfWidgetFormInputText(array(),array('placeholder'=>'0','class' => 'form-control'));
      $this->widgetSchema['rango_hasta'] = new sfWidgetFormInputText(array(),array('placeholder'=>'0','class' => 'form-control'));
