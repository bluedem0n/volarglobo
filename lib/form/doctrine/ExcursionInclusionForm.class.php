 ...
 */
class ExcursionInclusionForm extends BaseExcursionInclusionForm
{
  public function configure()
  {
        ...
        $this->widgetSchema['nombre'] = new sfWidgetFormInputText(array(), array('placeholder' => 'Nombre de la inclusión', 'class' => 'form-control'));
