...
Doctrine_Manager::getInstance()->bindComponent('TipoCanastilla', 'doctrine');
 ...
 * @method TipoCanastilla      setNombre()      Sets the current record's "nombre" value
 * @method TipoCanastilla      setDescripcion() Sets the current record's "descripcion" value
 * @method TipoCanastilla      setOrden()       Sets the current record's "orden" value
 * @method TipoCanastilla      setImagen()      Sets the current record's "imagen" value
 * @method TipoCanastilla      setStatus()      Sets the current record's "status" value
 ...
 */
abstract class BaseTipoCanastilla extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('tipo_canastilla');
